...
|---|---|---|
| `PUBLIC_SANITY_DATASET` | client-visible | src/utils/sanity.js |
| `PUBLIC_SANITY_PROJECT_ID` | client-visible | src/utils/sanity.js |
| `SANITY_READ_TOKEN` | server-only | src/utils/sanity.js |
