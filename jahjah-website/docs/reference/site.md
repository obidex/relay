...
| /api/staff/login | endpoint | **on-demand** | src/pages/api/staff/login.ts |
| /api/staff/logout | endpoint | **on-demand** | src/pages/api/staff/logout.ts |
| /api/staff/me | endpoint | **on-demand** | src/pages/api/staff/me.ts |
| /api/staff/mfa/enroll | endpoint | **on-demand** | src/pages/api/staff/mfa/enroll.ts |
| /api/staff/mfa/verify | endpoint | **on-demand** | src/pages/api/staff/mfa/verify.ts |
...
|---|---|---|
| `CLAUDE_THINK` | server-only | scripts/dispatch/hooks/pre-bash.mjs |
| `PATH` | server-only | scripts/dispatch/hooks/pre-bash.test.mjs |
...
| `SUPABASE_SERVICE_ROLE_KEY` | server-only | src/lib/env.ts, scripts/db-smoke.mjs, scripts/staff-add.mjs, scripts/staff-mfa-reset.mjs, scripts/staff-remove.mjs, scripts/staff-smoke.mjs |
| `SUPABASE_URL` | server-only | src/lib/env.ts, scripts/db-smoke.mjs, scripts/staff-add.mjs, scripts/staff-mfa-reset.mjs, scripts/staff-remove.mjs, scripts/staff-smoke.mjs |
