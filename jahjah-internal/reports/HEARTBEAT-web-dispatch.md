...
**Written (UTC):** 2026-09-12T04:22:04Z
**State:** OK — idle, no `chunk:approved` issue open
**Chunk in flight:** none
**Chunks started today (UTC 2026-09-12):** 0 of 3
...
chunk will sit untouched. Look for `ALERT-web-dispatch-disabled.md` or
`ALERT-web-dispatch-chunks-disabled.md` next to this file; if both are absent, the box or the timer
itself is down.
