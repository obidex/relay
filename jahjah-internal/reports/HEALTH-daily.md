...
**Generated (UTC):** 2026-09-03T09:08:26Z · **Verdict:** **OK** — everything below is within normal bounds.
...
|---|---|---|---|---|---|---|
| `jahjah-backup` | enabled | 7h 8m ago | success | 0 / 3 | 2026-09-04 02:00 | ok: 1.7M in 3s, 95 tables, 4 kept, 0 rotated out |
| `jahjah-dispatcher` | enabled | 0m ago | success | 0 / 3 | 2026-09-03 09:13 | — |
| `jahjah-erp-dispatch` | enabled | 1m ago | success | 0 / 3 | 2026-09-03 09:09 | ok: idle — nothing approved |
| `jahjah-health` | enabled | running now | success | 0 / 3 | (running now) | ok: published HEALTH-daily.md — 2 attention item(s), 13 job(s) in the ledger |
...
| `jahjah-web-backup-check` | enabled | 13h 31m ago | success | 0 / 3 | 2026-09-07 03:30 | ok: OK — sanity-production-20260902-045203.tar.gz (14h old): product=22 ok; brand=5 ok;  |
| `jahjah-web-backup` | enabled | 6h 38m ago | success | 0 / 3 | 2026-09-04 02:30 | ok: 62K in 4s, 33 documents, 2 kept, 0 rotated out |
| `jahjah-web-dispatch` | enabled | 0m ago | success | 0 / 3 | 2026-09-03 09:10 | ok: idle — nothing approved |
| `jahjah-web-docs` | enabled | 1m ago | success | 0 / 3 | 2026-09-03 09:37 | ok: no change (6e28bc3) |
...
| Memory | 2043 MB used of 3819 MB (53%), 1776 MB available |
| Swap | 371 MB used of 4095 MB (9%) |
| Load | 1.19, 0.37, 0.13 (over 2 cores) |
| Uptime | 4 days, 11 hours, 46 minutes |
...
|---|---|---|---|---|---|
| `jahjah-web-dispatch` | `obidex/jahjah-website` | OK — idle, no `chunk:approved` issue open | 42m ago | none | — |
| `jahjah-erp-dispatch` | `obidex/jahjah-internal` | OK — idle, no `chunk:approved` issue open | 3m ago | none | — |
...
|---|---|
| State | ACTIVE |
| Last decision | ALLOW (of 12 logged) |
...
accident guard is off. Only the decision KIND is published; the log stays on the box.
