...
**Generated (UTC):** 2026-09-09T05:00:04Z · **Verdict:** **OK** — everything below is within normal bounds.
...
|---|---|---|---|---|---|---|
| `jahjah-backup` | enabled | 2h 59m ago | success | 0 / 3 | 2026-09-10 02:00 | ok: 1.8M in 3s, 95 tables, 7 kept, 1 rotated out |
| `jahjah-dispatcher` | enabled | running now | success | 0 / 3 | (running now) | — |
| `jahjah-erp-dispatch` | enabled | 1m ago | success | 0 / 3 | 2026-09-09 05:01 | ok: idle — nothing approved |
...
| `jahjah-retention` | enabled | 2d 22h ago | success | 0 / 3 | 2026-09-13 06:00 | ok: 2 folder(s), 48 pruned, newest 10 kept per folder |
| `jahjah-scan-gitleaks` | enabled | 2d 0h ago | success | 0 / 3 | 2026-09-14 04:00 | ok: published SCAN-gitleaks.md — 0 hit(s) across 813 commits |
| `jahjah-scan-trivy` | enabled | 2d 1h ago | success | 0 / 3 | 2026-09-14 03:00 | ok: published SCAN-trivy.md — 6 targets, 10 critical, 150 high, 181 medium, 132 low |
| `jahjah-web-backup-check` | enabled | 2d 1h ago | success | 0 / 3 | 2026-09-14 03:30 | ok: OK — sanity-production-20260907-023004.tar.gz (0h old): product=22 ok; brand=5 ok; c |
| `jahjah-web-backup` | enabled | 2h 29m ago | success | 0 / 3 | 2026-09-10 02:30 | ok: 62K in 2s, 33 documents, 7 kept, 1 rotated out |
| `jahjah-web-dispatch` | enabled | running now | success | 0 / 3 | (running now) | ok: idle — nothing approved |
| `jahjah-web-docs` | enabled | 23m ago | success | 0 / 3 | 2026-09-09 05:07 | ok: no change (4b45dbc) |
| `jahjah-web-truth` | enabled | 1d 23h ago | success | 0 / 3 | 2026-09-14 05:30 | ok: build **clean**, 68 page(s), 1 live issue(s) |
...
| Memory | 1216 MB used of 3819 MB (31%), 2603 MB available |
| Swap | 404 MB used of 4095 MB (9%) |
| Load | 0.02, 0.03, 0.00 (over 2 cores) |
| Uptime | 1 week, 3 days, 7 hours, 37 minutes |
...
| `jahjah-erp-dispatch` | `obidex/jahjah-internal` | OK — idle, no `chunk:approved` issue open | 27m ago | none | — |
