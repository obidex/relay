...
**Generated (UTC):** 2026-09-02T19:27:34Z · **Verdict:** **NEEDS ATTENTION — 2 item(s)**
...
|---|---|---|---|---|---|---|
| `jahjah-backup` | enabled | 17h 27m ago | success | 0 / 3 | 2026-09-03 02:00 | ok: 1.6M in 2s, 95 tables, 3 kept, 0 rotated out |
| `jahjah-dispatcher` | enabled | 3m ago | success | 0 / 3 | 2026-09-02 19:28 | — |
...
| `jahjah-web-backup-check` | enabled | 1h 3m ago | success | 0 / 3 | 2026-09-07 03:30 | ok: OK — sanity-production-20260902-045203.tar.gz (13h old): product=22 ok; brand=5 ok;  |
| `jahjah-web-backup` | enabled | 14h 35m ago | success | 0 / 3 | 2026-09-03 02:30 | ok: 62K in 2s, 33 documents, 1 kept, 0 rotated out |
| `jahjah-web-dispatch` | enabled | 1m ago | success | 0 / 3 | 2026-09-02 19:28 | ok: idle — nothing approved |
| `jahjah-web-docs` | enabled | 20m ago | success | 0 / 3 | 2026-09-02 19:37 | ok: mirrored 44bef69, 6 file(s), 0 absent |
...
|---|---|
| Verdict | **OK** |
| Last checked | 1h 3m ago |
| Detail | sanity-production-20260902-045203.tar.gz (13h old): product=22 ok; brand=5 ok; category=6 ok; 3 image reference(s), all present; 3 image file(s) in the archive; 33 documents total |
...
| Memory | 1273 MB used of 3819 MB (33%), 2546 MB available |
| Swap | 239 MB used of 4095 MB (5%) |
| Load | 0.11, 0.26, 0.27 (over 2 cores) |
| Uptime | 3 days, 22 hours, 5 minutes |
