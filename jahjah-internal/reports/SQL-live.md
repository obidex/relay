...
<!-- index: nightly SQL suites vs LIVE — PASS 28/28 in 11s -->

**Generated (UTC):** 2026-09-10T17:04:00Z
...
|---|---|---|
| `activity_log_record_history_tests` | PASS | 0.4 |
| `activity_log_tests` | PASS | 0.3 |
| `arabic_cut_tests` | PASS | 0.4 |
| `catalog_supplier_tests` | PASS | 0.6 |
| `fx_cut_tests` | PASS | 0.4 |
