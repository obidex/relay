...
Generated 2026-09-16T15:37:04Z by `jahjah-erp-dispatch`. **Rebuilt from disk on every publish** — read this instead
...
|---|---|---|
| `HEALTH-daily.md` | 2026-09-16T05:00:06Z | daily health — OK, all 12 automations alive |
| `HEARTBEAT-erp-dispatch.md` | 2026-09-16T15:37:04Z | proof-of-life for the ERP chunk lane — stale > ~70 min means chunks are not being picked up |
| `HEARTBEAT-web-dispatch.md` | 2026-09-16T15:14:05Z | proof-of-life for the website chunk lane — stale > ~70 min means chunks are not being picked up |
| `HEARTBEAT-web-docs.md` | 2026-09-16T14:37:06Z | proof-of-life for the website canon mirror — stale > ~70 min means the mirror is not running |
| `README.md` | 2026-08-31T21:04:58Z | jahjah-internal — machine reports |
| `SCAN-gitleaks.md` | 2026-09-14T04:00:08Z | weekly gitleaks scan — ZERO secrets found in either repo history |
| `SCAN-trivy.md` | 2026-09-14T03:00:45Z | weekly trivy scan — 13 critical, 368 high, 534 medium, 328 low |
| `SQL-live.md` | 2026-09-16T03:15:18Z | nightly SQL suites vs LIVE — PASS 28/28 in 12s |
