...
Generated 2026-09-15T05:48:04Z by `jahjah-web-dispatch`. **Rebuilt from disk on every publish** — read this instead
...
|---|---|---|
| `HEALTH-daily.md` | 2026-09-15T05:00:07Z | daily health — OK, all 12 automations alive |
| `HEARTBEAT-erp-dispatch.md` | 2026-09-15T05:21:05Z | proof-of-life for the ERP chunk lane — stale > ~70 min means chunks are not being picked up |
| `HEARTBEAT-web-dispatch.md` | 2026-09-15T05:48:04Z | proof-of-life for the website chunk lane — stale > ~70 min means chunks are not being picked up |
| `HEARTBEAT-web-docs.md` | 2026-09-15T05:37:04Z | proof-of-life for the website canon mirror — stale > ~70 min means the mirror is not running |
...
| `SQL-live.md` | 2026-09-15T03:15:18Z | nightly SQL suites vs LIVE — PASS 28/28 in 11s |
