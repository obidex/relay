...
Generated 2026-09-19T20:13:04Z by `jahjah-erp-dispatch`. **Rebuilt from disk on every publish** — read this instead
...
|---|---|---|
| `HEALTH-daily.md` | 2026-09-19T05:00:07Z | daily health — NEEDS ATTENTION (3 item(s)) |
| `HEARTBEAT-erp-dispatch.md` | 2026-09-19T20:13:04Z | proof-of-life for the ERP chunk lane — stale > ~70 min means chunks are not being picked up |
...
| `HEARTBEAT-web-docs.md` | 2026-09-19T20:07:06Z | proof-of-life for the website canon mirror — stale > ~70 min means the mirror is not running |
...
| `SQL-live.md` | 2026-09-19T03:15:18Z | nightly SQL suites vs LIVE — PASS 28/28 in 12s |
