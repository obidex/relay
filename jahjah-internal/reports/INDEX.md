...
Generated 2026-09-21T10:49:03Z by `jahjah-erp-dispatch`. **Rebuilt from disk on every publish** — read this instead
...
|---|---|---|
| `HEALTH-daily.md` | 2026-09-21T05:00:06Z | daily health — NEEDS ATTENTION (3 item(s)) |
| `HEARTBEAT-erp-dispatch.md` | 2026-09-21T10:49:03Z | proof-of-life for the ERP chunk lane — stale > ~70 min means chunks are not being picked up |
...
| `HEARTBEAT-web-docs.md` | 2026-09-21T10:37:06Z | proof-of-life for the website canon mirror — stale > ~70 min means the mirror is not running |
| `README.md` | 2026-08-31T21:04:58Z | jahjah-internal — machine reports |
| `SCAN-gitleaks.md` | 2026-09-21T04:00:10Z | weekly gitleaks scan — ZERO secrets found in either repo history |
| `SCAN-trivy.md` | 2026-09-21T03:00:15Z | weekly trivy scan — 13 critical, 376 high, 531 medium, 344 low |
| `SQL-live.md` | 2026-09-21T03:15:17Z | nightly SQL suites vs LIVE — PASS 28/28 in 12s |

## Dated reports (newest first — pruned to the newest 10 by `jahjah-retention`)

| File | Updated (UTC) | What it is |
|---|---|---|
| `2026-09-17-design-rulings-1-final.md` | 2026-09-17T14:50:05Z | KIND: final |
| `2026-09-17-design-record-1-final.md` | 2026-09-17T11:50:47Z | KIND: final |
