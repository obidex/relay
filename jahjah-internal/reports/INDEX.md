...
Generated 2026-09-21T04:59:03Z by `jahjah-erp-dispatch`. **Rebuilt from disk on every publish** — read this instead
...
|---|---|---|
| `HEALTH-daily.md` | 2026-09-20T05:00:05Z | daily health — NEEDS ATTENTION (3 item(s)) |
| `HEARTBEAT-erp-dispatch.md` | 2026-09-21T04:59:03Z | proof-of-life for the ERP chunk lane — stale > ~70 min means chunks are not being picked up |
...
| `HEARTBEAT-web-docs.md` | 2026-09-21T04:37:06Z | proof-of-life for the website canon mirror — stale > ~70 min means the mirror is not running |
