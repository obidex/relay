...
Generated 2026-09-17T14:50:03Z by `jahjah-session`. **Rebuilt from disk on every publish** — read this instead
...
| `HEARTBEAT-web-docs.md` | 2026-09-17T14:37:05Z | proof-of-life for the website canon mirror — stale > ~70 min means the mirror is not running |
...
| File | Updated (UTC) | What it is |
|---|---|---|
| `2026-09-17-design-rulings-1-final.md` | 2026-09-17T14:50:03Z | KIND: final |
