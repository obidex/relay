...
Generated 2026-09-14T04:00:04Z by `jahjah-scan-gitleaks`. **Rebuilt from disk on every publish** — read this instead
...
|---|---|---|
| `HEALTH-daily.md` | 2026-09-13T05:00:06Z | daily health — OK, all 12 automations alive |
| `HEARTBEAT-erp-dispatch.md` | 2026-09-14T03:21:05Z | proof-of-life for the ERP chunk lane — stale > ~70 min means chunks are not being picked up |
| `HEARTBEAT-web-dispatch.md` | 2026-09-14T03:58:05Z | proof-of-life for the website chunk lane — stale > ~70 min means chunks are not being picked up |
| `HEARTBEAT-web-docs.md` | 2026-09-14T03:37:05Z | proof-of-life for the website canon mirror — stale > ~70 min means the mirror is not running |
| `README.md` | 2026-08-31T21:04:58Z | jahjah-internal — machine reports |
| `SCAN-gitleaks.md` | 2026-09-14T04:00:04Z | weekly gitleaks scan — ZERO secrets found in either repo history |
| `SCAN-trivy.md` | 2026-09-14T03:00:45Z | weekly trivy scan — 13 critical, 368 high, 534 medium, 328 low |
| `SQL-live.md` | 2026-09-14T03:15:17Z | nightly SQL suites vs LIVE — PASS 28/28 in 11s |
